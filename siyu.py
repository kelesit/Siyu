...
def initial_embeddings(openai_api_key, first_task):
    ...
    print("Initial Embeddings ... Done")

    return vectorstore


def main():
    print("### Siyu's Baby AGI ###")
    print("Insert your OpenAI API key:")
    openai_api_key = input()
    if openai_api_key:
        print("Insert your Ultimate Goal: ")
        OBJECTIVE = input()
        first_task = "Write a todo list"

        max_iterations = 3
        vectorstore = initial_embeddings(openai_api_key, first_task)

        try:
            Siyu_agi = BabyAGI.from_llm_and_objectives(
            ...
            Siyu_agi.run(max_iterations=max_iterations)
        except Exception as e:
            print(e)
            print("Siyu's Baby AGI is terminated.")
    else:
